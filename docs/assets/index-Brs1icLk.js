      ...
      (function (n, a) {
        (function (o, i) {
          ...
          function X(e) {
            var t, r;
            return (r =
              (t = D.exec(e)) === null || t === void 0 ? void 0 : t[0]) !==
              null && r !== void 0
              ? r
              : null;
          }
          ...
          function g(e) {
            const t = (r, s, c) => {
              const d = r.lexer.current.type,
                T = r.lexer.next.type;
              if (c === null) {
                if ('parsePrefix' in e && e.accept(d, T))
            ...
            return g({
              ...
              parsePrefix: (r) => {
                ...
                if (r.consume('StringValue'))
                  ...
                  let k = '';
                  const S = ['Identifier', '@', '/'];
                  for (; S.some((x) => r.consume(x)); )
                    (k += d.text), (d = r.lexer.current);
                  c = {
                    type: 'JsdocTypeSpecialNamePath',
                    value: k,
                    specialType: s,
          ...
          const Re = [
            ...
            V = [...Re, te({ allowedTypes: ['event'], pathGrammar: Re })];
          function ue(e) {
            let t;
          ...
          function ye({
            ...
            return g({
              ...
              parsePrefix: (c) => {
                ...
                if (e === void 0) J.parameters = Qt(k);
                else {
                  if (d && k.type === 'JsdocTypeFunction' && k.arrow)
                    return (J = k), (J.constructor = !0), J;
                  J.parameters = ue(k);
                  for (const S of J.parameters)
                    if (S.type === 'JsdocTypeKeyValue' && !e.includes(S.key))
                      throw new Error(
                        `only allowed named parameters are ${e.join(', ')} but got ${S.type}`,
                      );
                }
              ...
              parsePrefix: (r) => {
                ...
                if (!r.consume('}')) {
                  ...
                  for (;;) {
                    ...
                    r.acceptLexerState(d),
                      T === void 0 &&
                        t &&
                        (T = r.parseIntermediateType(f.OBJECT));
                    let J = !1;
                    if (
                      ...
                      let S;
                      T.type === 'JsdocTypeStringValue' && (S = T.meta.quote),
                        s.elements.push({
              ...
              parseInfix: (c, d) => {
                ...
                s &&
                  ...
                  r &&
                    ...
                    ((k = !0), (d = d.element));
                const S = (T = c.baseParser) !== null && T !== void 0 ? T : c;
                if (
                  (S.acceptLexerState(c),
                  d.type === 'JsdocTypeNumber' ||
                    d.type === 'JsdocTypeName' ||
                    d.type === 'JsdocTypeStringValue' ||
                    le(d))
                ) {
                  if (le(d) && !e) throw new y(d);
                  S.consume(':');
                  let x;
                  d.type === 'JsdocTypeStringValue' && (x = d.meta.quote);
                  const re = S.parseType(f.KEY_VALUE);
                  return (
                    c.acceptLexerState(S),
                    {
                      type: 'JsdocTypeObjectField',
                      key: le(d) ? d : d.value.toString(),
                      right: re,
                      optional: J,
                      readonly: k,
                      meta: { quote: x },
                  ...
                  if (!t) throw new y(d);
                  S.consume(':');
                  const x = S.parseType(f.KEY_VALUE);
                  return (
                    c.acceptLexerState(S),
                    { type: 'JsdocTypeJsdocObjectField', left: w(d), right: x }
                  );
                }
              },
            });
          ...
          const Le = [
            ...
            Zt = [
              ...
              I({ allowedAdditionalTokens: ['keyof'] }),
              te({ allowedTypes: ['module'], pathGrammar: V }),
              ee({
                allowSquareBracketsOnAnyType: !1,
                allowJsdocNamePaths: !0,
                pathGrammar: V,
          ...
          const nn = g({
                ...
                if (e.consume(':')) {
                  ...
                  s.acceptLexerState(e),
                    (r = {
                      ...
                      key: t,
                      right: s.parseType(f.INDEX_BRACKETS),
                    }),
                  ...
                  s.acceptLexerState(e),
                    (r = {
                      ...
                      key: t,
                      right: s.parseType(f.ARRAY_BRACKETS),
                    }),
                    e.acceptLexerState(s);
                } else
                  throw new Error(
            ...
            un = [
              ...pe,
              me({ allowKeyTypes: !1, objectFieldGrammar: pn }),
              je,
              nn,
              rn,
              $,
          ...
          function Ue(e, t) {
            switch (t) {
              ...
              case 'typescript':
                return new U(un, e).parse();
            }
          }
          function yn(e, t = ['typescript', 'closure', 'jsdoc']) {
            let r;
            for (const s of t)
              try {
                return Ue(e, s);
          ...
          function R(e) {
            ...
            return fn.includes(e) && (t.reservedWord = !0), t;
          }
          const Tn = {
            JsdocTypeOptional: (e, t) => {
              const r = t(e.element);
          ...
          function ge(e, t, r, s, c) {
            s == null || s(e, t, r);
            const d = Ke[e.type];
            for (const T of d) {
              const J = e[T];
              if (J !== void 0)
                if (Array.isArray(J)) for (const k of J) ge(k, e, T, s, c);
                else ge(J, e, T, s, c);
            }
            c == null || c(e, t, r);
          }
          function En(e, t, r) {
            ge(e, void 0, void 0, t, r);
          }
          (o.catharsisTransform = hn),
            (o.identityTransformRules = Nn),
            (o.jtpTransform = wn),
            (o.parse = Ue),
            (o.stringify = mn),
            (o.stringifyRules = De),
...
var Je = Pn(),
  ...
  l = (n, a) => Sn(n, 'name', { value: a, configurable: !0 });
const { UnknownArgTypesError: vn } =
  __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var kn = l((n) => n.name === 'literal', 'isLiteral'),
  xn = l((n) => n.value.replace(/['|"]/g, ''), 'toEnumOption'),
  On = l((n) => {
    switch (n.type) {
      case 'function':
      ...
      default:
        throw new vn({ type: n, language: 'Flow' });
    }
  }, 'convertSig'),
  Y = l((n) => {
    var p, u, y, m;
    ...
    switch ((typeof o < 'u' && (i.raw = o), n.name)) {
      ...
      case 'signature':
        return { ...i, ...On(n) };
      case 'union':
        return (p = n.elements) != null && p.every(kn)
          ? {
              ...i,
              name: 'enum',
              value: (u = n.elements) == null ? void 0 : u.map(xn),
            }
          : {
              ...i,
              name: a,
              value: (y = n.elements) == null ? void 0 : y.map(Y),
            };
      case 'intersection':
        return {
          ...i,
          name: a,
          value: (m = n.elements) == null ? void 0 : m.map(Y),
        };
      default:
...
l(Be, 'mapValues');
var Ce = /^['"]|['"]$/g,
  In = l((n) => n.replace(Ce, ''), 'trimQuotes'),
  An = l((n) => Ce.test(n), 'includesQuotes'),
  Ye = l((n) => {
    let a = In(n);
    return An(n) || Number.isNaN(Number(a)) ? a : Number(a);
  }, 'parseLiteral'),
  Rn = /^\(.*\) => /,
  C = l((n) => {
    ...
    switch ((typeof o < 'u' && (u.raw = o), a)) {
      ...
      case 'union':
        return { ...u, name: 'union', value: p.map((m) => C(m)) };
      case 'instanceOf':
      case 'element':
      case 'elementType':
      default: {
        if ((a == null ? void 0 : a.indexOf('|')) > 0)
          try {
            let b = a.split('|').map((N) => JSON.parse(N));
            return { ...u, name: 'enum', value: b };
          } catch {}
        let m = p ? `${a}(${p})` : a,
          h = Rn.test(a) ? 'function' : 'other';
        return { ...u, name: h, value: m };
      }
    }
  }, 'convert');
const { UnknownArgTypesError: _n } =
  __STORYBOOK_MODULE_CORE_EVENTS_PREVIEW_ERRORS__;
var Fn = l((n) => {
    switch (n.type) {
      case 'function':
      ...
      default:
        throw new _n({ type: n, language: 'Typescript' });
    }
  }, 'convertSig'),
  G = l((n) => {
    var p, u, y, m;
    ...
    switch ((typeof o < 'u' && (i.raw = o), n.name)) {
      ...
      case 'union':
        let h;
        return (
          (p = n.elements) != null && p.every((b) => b.name === 'literal')
            ? (h = {
                ...i,
                name: 'enum',
                value:
                  (u = n.elements) == null ? void 0 : u.map((b) => Ye(b.value)),
              })
            : (h = {
                ...i,
                name: a,
                value: (y = n.elements) == null ? void 0 : y.map(G),
              }),
          h
        );
      case 'intersection':
        return {
          ...i,
          name: a,
          value: (m = n.elements) == null ? void 0 : m.map(G),
        };
      default:
        return { ...i, name: 'other', value: a };
    }
...
function Xe(n) {
  return Ne(n) ? Un(n.__docgenInfo.description) : '';
}
...
function tt({ fence: n = '```' } = {}) {
  ...
  return l(function (i) {
    let p = [[]],
      u = !1;
    for (let y of i)
      Vn.test(y.tokens.description) && !u
        ? p.push([y])
        : p[p.length - 1].push(y),
        (u = o(y.tokens.description, u));
    return p;
  }, 'parseBlock');
}
l(tt, 'getParser');
...
function rt({ startLine: n = 0, markers: a = _ } = {}) {
  ...
  return l(function (p) {
    ...
    if (
      ...
      let h = u.trimRight();
      (y.end = u.slice(h.length - a.end.length)),
        (u = h.slice(0, -a.end.length));
    }
    if (
      ((y.description = u), o.push({ number: i, source: p, tokens: y }), i++, m)
    ) {
      let h = o.slice();
      return (o = null), h;
    }
  ...
  return (o) => {
    ...
    for (let [m, { tokens: h }] of o.source.entries()) {
      ...
      for (let N of h.description)
        if ((N === '{' && i++, N === '}' && i--, (b += N), i === 0)) break;
      if ((p.push([h, b]), i === 0)) break;
    }
    if (i !== 0)
      return (
        o.problems.push({
    ...
    for (let [m, [h, b]] of p.entries())
      (h.type = b),
        m > 0 &&
          ((h.type = h.postDelimiter.slice(y) + b),
          (h.postDelimiter = h.postDelimiter.slice(0, y))),
        ([h.postType, h.description] = j(h.description.slice(b.length))),
        u.push(h.type);
    return (
      (u[0] = u[0].slice(1)),
...
l(it, 'getJoiner');
var Kn = l((n) => n && n.startsWith('"') && n.endsWith('"'), 'isQuoted');
function lt() {
...
l(pt, 'compactJoiner');
var $n = l((n, { tokens: a }, o) => (a.type === '' ? n : o), 'lineNo'),
  qn = l(
    ({ tokens: n }) =>
  ...
  return function (b) {
    ...
    for (let oe of ze(b)) {
      ...
      N.push({
        ...
        tags: Q,
        source: D,
        problems: Q.reduce((P, se) => P.concat(se.problems), []),
      });
    }
    return N;
  };
...
function Jt(n) {
  ...
  return {
    ...
    getPrettyName: l(() => gt(n.name), 'getPrettyName'),
    getTypeName: l(() => (a ? ve(a) : null), 'getTypeName'),
  };
}
l(Jt, 'extractParam');
function wt(n) {
...
function Nt(n) {
  ...
  return a
    ? {
        ...
        getTypeName: l(() => ve(a), 'getTypeName'),
      }
    : null;
}
l(Nt, 'extractReturns');
var F = Je.stringifyRules(),
  Yn = F.JsdocTypeObject;
F.JsdocTypeAny = () => 'any';
F.JsdocTypeObject = (n, a) => `(${Yn(n, a)})`;
...
l(Et, 'isTooLongForDefaultValueSummary');
function E(n, a) {
...
function bt(n, a) {
  if (n != null) {
    let { value: o } = n;
    if (!ae(o)) return Et(o) ? E(a == null ? void 0 : a.name, o) : E(o);
  }
  return null;
}
...
function Pt({ name: n, raw: a, elements: o }) {
  return o != null
    ? E(o.map(xe).join(' | '))
    : a != null
      ? E(a.replace(/^\|\s*/, ''))
...
l(Pt, 'generateUnion');
function St({ type: n, raw: a }) {
  return a != null ? E(a) : E(n);
}
l(St, 'generateFuncSignature');
...
var Xn = l((n, a, o) => {
  ...
  or = l((n, a) => {
    let o = We(n, a);
    return Ge(o) ? (Array.isArray(o) ? Zn(o) : er(o)) : [];
  }, 'extractComponentProps');
function Ie(n, a, o, i) {
  let p = Cn(a.description);
...
l(tr, 'extractComponentDescription');
const { combineParameters: nr } = __STORYBOOK_MODULE_PREVIEW_API__;
var sr = l((n) => {
    let {
        component: a,
        argTypes: o,
