...
function Y() {
  ...
  var v = (m.prototype = new j());
  (v.constructor = m), b(v, y.prototype), (v.isPureReactComponent = !0);
  var O = Array.isArray,
  ...
  function P(e, t, n) {
    ...
    if (t != null)
      ...
      t))
        g.call(t, o) && !x.hasOwnProperty(o) && (u[o] = t[o]);
  ...
  function d(e, t, n, o, u) {
    ...
    if (((s = 0), (o = o === '' ? '.' : o + ':'), O(e)))
      ...
      for (e = c.call(e), f = 0; !(i = e.next()).done; )
        (i = i.value), (c = o + E(i, f++)), (s += d(i, t, n, c, u));
    else if (i === 'object')
      throw (
        ((t = String(e)),
        Error(
  ...
  return (
    ...
    (r.cloneElement = function (e, t, n) {
      ...
      return { $$typeof: a, type: e.type, key: u, ref: i, props: o, _owner: s };
    }),
